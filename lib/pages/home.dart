      ...
      child: Container(
        ...
        children: [
          ...
          children: [
            Text(
            temperature,
            style: TextStyle(fontSize: 64, fontWeight: FontWeight.bold, color: Colors.black87),
            ),
            SizedBox(width: 8),
            Text(
            'C',
          ...
          Text(
          weatherDescription,
          style: TextStyle(fontSize: 22, color: Colors.amber, fontWeight: FontWeight.w500),
          ),
          ...
          children: [
            ...
            children: [
              ...
              Text(windSpeed, style: TextStyle(fontWeight: FontWeight.bold)),
            ],
            ),
            Column(
            children: [
